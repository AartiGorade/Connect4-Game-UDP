...
public class Connect4GameModel_client1 implements Observer {
	...
	public Connect4GameModel_client1() {
	...
	public Connect4GameModel_client1(Connect4GameModel_client1 aConnect4Field) {
	...
	public void update(Observable arg0, Object arg1) {
		...
		if (arg1 instanceof Integer) {
			checkAndDrop((GameControl_client1) arg0);
		}
	}

	/**
	 * Check and drop it in the specified location of gameControl
	 * @param GameControl_client1
	 */
	public void checkAndDrop(GameControl_client1 GameControl_client1) {
		int move = GameControl_client1.getCurrentgameMove();
		char gameChar = GameControl_client1.getCurrentGamePiece();
		if (checkIfPiecedCanBeDroppedIn(move)) {
			dropPieces(move, gameChar);
			if (isItaDraw()) {
				GameControl_client1.setGameTie();
			}
			if (didLastMoveWin()) {
				GameControl_client1.setGameWin();

			}
		} else {
			GameControl_client1.setGameError("Invalid Drop");
		}

 ...
 * 
 * Client Player Model implementation with UDP mode of connection
 * 
 */
...
public class Connect4GameModel_client2 implements Observer {
	...
	public Connect4GameModel_client2() {
	...
	public Connect4GameModel_client2(Connect4GameModel_client2 aConnect4Field) {
	...
	public void update(Observable arg0, Object arg1) {
		...
		if (arg1 instanceof Integer) {
			checkAndDrop((GameControl_client2) arg0);
		}
	}

	/**
	 * Check and drop it in the specified location of gameControl
	 * @param GameControl_client2
	 */
	public void checkAndDrop(GameControl_client2 GameControl_client2) {
		int move = GameControl_client2.getCurrentgameMove();
		char gameChar = GameControl_client2.getCurrentGamePiece();
		if (checkIfPiecedCanBeDroppedIn(move)) {
			dropPieces(move, gameChar);
			if (isItaDraw()) {
				GameControl_client2.setGameTie();
			}
			if (didLastMoveWin()) {
				GameControl_client2.setGameWin();

			}
		} else {
			GameControl_client2.setGameError("Invalid Drop");
		}

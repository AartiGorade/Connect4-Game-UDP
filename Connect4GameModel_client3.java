...
public class Connect4GameModel_client3 implements Observer {
	...
	public Connect4GameModel_client3() {
	...
	public Connect4GameModel_client3(Connect4GameModel_client3 aConnect4Field) {
	...
	public void update(Observable arg0, Object arg1) {
		...
		if (arg1 instanceof Integer) {
			checkAndDrop((GameControl_client3) arg0);
		}
	}

	/**
	 * Check and drop it in the specified location of gameControl
	 * @param GameControl_client3
	 */
	public void checkAndDrop(GameControl_client3 GameControl_client3) {
		int move = GameControl_client3.getCurrentgameMove();
		char gameChar = GameControl_client3.getCurrentGamePiece();
		if (checkIfPiecedCanBeDroppedIn(move)) {
			dropPieces(move, gameChar);
			if (isItaDraw()) {
				GameControl_client3.setGameTie();
			}
			if (didLastMoveWin()) {
				GameControl_client3.setGameWin();

			}
		} else {
			GameControl_client3.setGameError("Invalid Drop");
		}

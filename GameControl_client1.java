...
public class GameControl_client1 extends Observable{

	private int currentUserMove;
	private boolean isGameTie;
	private boolean isGameWin;
	private Connect4GameModel_client1 connect4Board;
	private PlayerModel_client1 myPlayers[];
	private PlayerModel_client1 currentPlayer;
	...
	public GameControl_client1(String args[]){
		if ( args.length != 0 )
			parseArgs(args);
		try { 
            connectToServer();
...
public void playTheGame() throws ClassNotFoundException, IOException {
 ...
 try{
	...
	public PlayerModel_client1 getCurrentPlayer() {
	...
	public void init(Connect4GameModel_client1 gameBoard, PlayerModel_client1 p2) throws ClassNotFoundException, IOException {
		connect4Board = gameBoard;
		myPlayers = new PlayerModel_client1[2];
		myPlayers[0] = p2;
		String r="1";
		sendData(r);
	...
	public Connect4GameModel_client1 getGameBoard() {

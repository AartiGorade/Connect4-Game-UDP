...
public class GameControl_client2 extends Observable{

	private int currentUserMove;
	private boolean isGameTie;
	private boolean isGameWin;
	private Connect4GameModel_client2 connect4Board;
	private PlayerModel_client2 myPlayers[];
	private PlayerModel_client2 currentPlayer;
	...
	private final int myNumber=2;
	private InetAddress ip;
	
	public GameControl_client2(String args[]){
		if ( args.length != 0 )
			parseArgs(args);
		try { 
            connectToServer();
	...
	public void playTheGame() throws ClassNotFoundException, IOException {
		...
		do {
					...
					if(whosTurn==myNumber) {
						...
						System.out.println("whosTurn= "+whosTurn+" myNumber= "+myNumber);
						gameMessage = null;
	...
	public PlayerModel_client2 getCurrentPlayer() {
	...
	public void init(Connect4GameModel_client2 gameBoard, PlayerModel_client2 p2) throws ClassNotFoundException, IOException {
		connect4Board = gameBoard;
		myPlayers = new PlayerModel_client2[2];
		myPlayers[0] = p2;
		String r="1";
		sendData(r);
	...
	public Connect4GameModel_client2 getGameBoard() {
